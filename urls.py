...
import common.views
import bracelet.views
import admin.views
import ocomments.views
...
urlpatterns = [
    ...
    url(r'^login/?$', common.views.login_user, name = 'login_user'),
    url(r'^logout/?$', common.views.logout_user),
    url(r'^facebook_login/?$', common.views.facebook_login),
    url(r'^facebook_login_success/?$', common.views.facebook_login_success),
    ...
    url(r'^contact/success/?$', common.views.contact_success),

    # MODULE BRACELET
    url(r'^bracelet/photos/(?P<bracelet_id>\d+)/?$', bracelet.views.photos),
    url(r'^bracelet/photoUpload/(?P<bracelet_id>\d+)', bracelet.views.photo_upload),
    url(r'^bracelet/photo/remove/(?P<photo_id>\d+)', bracelet.views.delete_photo),
    url(r'^bracelet/remove/(?P<bracelet_id>\d+)/?$', bracelet.views.delete_bracelet),
    ...
    url(r'^superadmin/', include(django.contrib.admin.site.urls)),
]
