...
urlpatterns = patterns('',
    ...
    url(r'^facebook_login/$', 'ohiboka_patterns.bracelet.views.facebook_login'),
    url(r'^facebook_login_success/$', 'ohiboka_patterns.bracelet.views.facebook_login_success'),
